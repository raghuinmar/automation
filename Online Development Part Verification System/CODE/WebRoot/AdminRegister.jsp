...
window.location.href='http://'+host+':'+port+'/ETS/ChekUserAction?userName='+userName;
...
font-size:8pt
		...
		<body>
		   <h3><center><h3><font color="#FF1493"><b><i>Employee Register Form </i></b></font></h3>
<form action="./RegisterEmployees" method="post" name="register" onSubmit="return validate()">
...
<td><pre><span class=Title>Login Type</span></pre></td>
         <td>
  ...
  <tr>
    ...
    <td>
						<input type="text" name="dob" value="" size="20"
							readonly="readonly" />
						<a href="javascript:show_calendar('document.register.dob', document.register.dob.value);"> <img src="<%=request.getContextPath()+"/images/cal.gif"%>" alt="a" width="18" height="18" border="0"/></a>
					</td>
...
<tr>
 <img alt="See Photo Here" id="previewField" src="images/red rose 1.jpg" height="150" width="120">
