...
<fieldset>
					<legend><font color="#FFFWQNAM"><i> Query Status</font></legend>
                    <br />
    ...
    <table width="637" border="0" align="center" bordercolor="#8692E3">
      ...
      <%
	     ...
	     try{
             ...
             System.out.println("user in jsp is ..."+(String)session.getAttribute("user"));
        ...
        <td width="372"><div align="center" class="style8">Solution</div></td>
          ...
          <%
           ...
           %>
      <tr bgcolor="#F4F5F7">
              <td bgcolor="#F4F5F7"><input name="ch" type="checkbox" id="checkbox2" onClick="check1()" value="<%=queryid%>"/></td> 
      <td bgcolor="#F4F5F7"><div align="center"><span class="style7"><%=queryid%></span></div></td>
        <td bgcolor="#F4F5F7"><div align="center" class="style7">
         
        <%=aQuery.getQueryDate()%>
        </div></td>
        <td bgcolor="#F4F5F7"><div align="center"><span class="style7"><font color="red"><%=aQuery.getStatus()%></font></span></div></td>
        <%
           if(!aQuery.getStatus().equals("Process"))
           {
         %>
        <td bgcolor="#F4F5F7"><div align="center"><span class="style7"><u><a href="ViewSolutions.jsp?id=<%=queryid%>">View</a></u></span></div></td>
      </tr>
      <%}else {%> <td bgcolor="#F4F5F7"><div align="center"><span class="style7"><a href="ViewSolution.jsp?id=<%=queryid%>"></a></span></div></td> <%} %>
     <%  }
      }
      else 
      {%>
