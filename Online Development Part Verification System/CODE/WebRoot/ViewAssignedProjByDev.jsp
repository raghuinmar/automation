...
<center><h3><font color="#FF1493"><b><i>Current Working Project Details</b></font></h3></center>
    ...
    <table width="" border="0" align="center" bordercolor="#F4F5F7">
      ...
      <%
	     ...
	     try{
             ...
             inCoreList = new AssignProjectsDao().getProjAssignDetailsofDev(user);
       ...
       %>
         ...
         <td width="64"><div align="center" class="style8"><b>TeamLeadName</b></div></td>
         <td width=""></td>
      ...
      <tr bgcolor="#CEC9FA" >
        ...
        <td bgcolor="#F4F5F7"><div align="center"><span class="style7"><b><%=tlname %></b></span></div></td>
        <td width="" bgcolor="#F4F5F7"></td>
        <td bgcolor="#F4F5F7" ><div align="center" class="style7">  <i><%=projname%></i></div></td> 
        <td bgcolor="#F4F5F7"><div align="center" class="style7"><i><%=pcode%></div></td>
        
        <td bgcolor="#F4F5F7" ><div align="center" class="style7"><i>  <%=modules%></div></td> 
        <td bgcolor="#F4F5F7"><div align="center" class="style7"><i><%=sdate%></div></td>
        <td bgcolor="#F4F5F7"><div align="center"><span class="style7"><i><%=edate %></span></div></td>
