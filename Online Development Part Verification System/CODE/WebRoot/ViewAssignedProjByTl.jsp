...
<center><h3><font color="#FF1493"><b><i>View Assigned Project Details</b></font></h3></center>
    ...
    <table width="" border="0" align="center" bordercolor="#F4F5F7">
      ...
      <%
	     ...
	     try{
             ...
             inCoreList = new AssignProjectsDao().getProjAssignDetailsofTl(user);
       ...
       %>
         ...
         <td width="64"><div align="center" class="style8"><b></b></div></td>
         <td width=""></td>
