...
public final class ViewAsignedTeams_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(session.getAttribute("user")==null){
      ...
      out.write("\t<br><br>\t\t\r\n");
      out.write(" <center><h3><font color=\"#FF1493\"><b><i>View Assign Team's To TeamLead's</b></font></h3></center>\r\n");
      out.write("<form id=\"form1\" method=\"post\" action=\"ViewAsignedTeams.jsp\" name=\"viewassignteam\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tonchange=\"javascript:if(document.viewassignteam.tlid.value==''){alert('select Any TeamLead');}else{ document.viewassignteam.submit();}\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t--Select--\r\n");
      out.write("\t\t\t\t\t\t\t\t</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
 ...
 if(request.getParameter("status")!=null)
      ...
      out.write("\r\n");
      out.write("    <form action=\"./assignTeamsToTls\" method=\"post\"> \r\n");
      out.write("      \r\n");
...
if(request.getParameter("tlid")!=null) {
        tlid =Integer.parseInt(request.getParameter("tlid"));
	     ...
	     try{
             ...
             inCoreList = new ProfileDAO().getDevelopersDetailsofTl(tlid,path);
