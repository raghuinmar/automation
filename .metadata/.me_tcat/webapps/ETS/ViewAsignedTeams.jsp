...
<form id="form1" method="post" action="ViewAsignedTeams.jsp" name="viewassignteam">
    <table width="200" border="0" align="center">
      <tr>
        <td width=""><strong>SelectTeamLead</strong></td>
        <td width="90"><label>
          <select name="tlid" id="select"
								onchange="javascript:if(document.viewassignteam.tlid.value==''){alert('select Any TeamLead');}else{ document.viewassignteam.submit();}">
								<option>
									--Select--
								</option>
								<%
  ...
  <%
       ...
       { int tlid=0;
    %>
    <form action="./assignTeamsToTls" method="post"> 
