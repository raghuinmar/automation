...
<body>
<center>
<form action="" method="post" name="viewbydate" onsubmit="return formvalidation(this)">
<table>
...
<tr>
    ...
    <td width="95"><div align="left">
      <select name="did" id="select" onchange="javascript:if(document.viewbydate.did.value==''){alert('Select Any DeveloperName');} else{ location.href='ViewDevEffort.jsp?did='+document.viewbydate.did.value;}">
...
<th>HoursWorked</th>
    ...
    <tr>
    <td>
    <b>Report NotYet Submitted by the TeamLead</b>
    <td>
    </tr>
    </table>
